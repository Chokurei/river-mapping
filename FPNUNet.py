...
class FPNUNet(object):
    ...
    def __init__(self, args):
        self.model = fpnunet.FPNUNet(args.in_ch, args.out_ch, args.base_kernel)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-trans_model_name', type=str, \
                        default='FPNUNet_iter_1010.pth', help='model used for transfer')
    ...
    parser.add_argument('-trans_trigger', type=str, default='iter', choices=['epoch', 'iter'],
                        help='trigger type for logging')
    parser.add_argument('-trans_interval', type=int, default=2,
                        help='interval for logging')
