...
from config import SegNII_train, SegNII_test, SegNII_trans
...
class FPN(object):
    ...
    def __init__(self, args):
        self.model = fpn.FPN(args.in_ch, args.out_ch, args.base_kernel)
...
def main(args):
    ...
    if args.train:
        ...
        # initialize datasets
        datasets_train = SegNII_train(args)
    ...
    if args.test:
        ...
        datasets_test = SegNII_test(args)
    ...
    if args.trans:
        ...
        datasets_trans = SegNII_trans(args)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-train_data', type=str, default='river_train_20201001-rand',
    ...
    # parser.add_argument('-data_aug', type=lambda x: (str(x).lower() == 'true'), default=True,
    ...
    parser.add_argument('-ground_truth', type=lambda x: (str(x).lower() == 'true'), \
                        default=False, help='have ground truth or not')
